...
class MessageBubbleNoInfo extends StatelessWidget {
  final String sender;
  final String text;
  final String hour;
  final bool isMe;
            ...
            Material(
              ...
              borderRadius: BorderRadius.only(
                ...
                topRight: isMe
                    ? Radius.zero
                    : Radius.circular(PopupTabletConstants.resize(20)),
                bottomLeft: Radius.circular(PopupTabletConstants.resize(20)),
                bottomRight: Radius.circular(PopupTabletConstants.resize(20)),
              ),
              elevation: 5.0,
              child: Padding(
                padding: EdgeInsets.symmetric(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.only(
          top: PopupTabletConstants.resize(7.5),
          bottom: PopupTabletConstants.resize(bottomPadding),
          right: isMe ? PopupTabletConstants.resize(72) : 0,
          left: isMe ? 0 : PopupTabletConstants.resize(72)),
      child: Row(
        mainAxisAlignment:
            isMe ? MainAxisAlignment.end : MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.start,
