...
void main() {
  ...
  group('LoginForm', () {
    ...
    const Size tabletLandscapeSize = Size(1024, 1374);
    const double devicePixelRatio = 1;
        ...
        await tester.pumpWidget(
          MediaQuery(
            data: const MediaQueryData(
                size: tabletLandscapeSize, devicePixelRatio: devicePixelRatio),
    ...
    group('navigates', () {
      testWidgets('to SignUpPage when Create Account is pressed',
        ...
        expect(find.byType(SignUpTabletPage), findsOneWidget);
      });
